...
#endif
static const char *ng0 = "/home/omshripc/Sem 5/EE2003/ISE/expt3/DMEM_Parser.v";
...
LAB22:    t3 = ((char*)((ng9)));
    t40 = xsi_vlog_unsigned_case_compare(t4, 5, t3, 5);
    if (t40 == 1)
        goto LAB23;

LAB24:    t6 = ((char*)((ng10)));
    t41 = xsi_vlog_unsigned_case_compare(t4, 5, t6, 5);
    if (t41 == 1)
        goto LAB25;
...
LAB9:    xsi_set_current_line(10, ng0);
    ...
    *((unsigned int *)t3) = (t14 & 255U);
    t8 = ((char*)((ng1)));
    xsi_vlogtype_concat(t5, 32, 32, 2U, t8, 24, t15, 8);
    t16 = (t0 + 1608);
...
LAB15:    xsi_set_current_line(13, ng0);
    ...
    *((unsigned int *)t3) = (t14 & 65535U);
    t8 = ((char*)((ng1)));
    xsi_vlogtype_concat(t5, 32, 32, 2U, t8, 16, t15, 16);
    t16 = (t0 + 1608);
    xsi_vlogvar_wait_assign_value(t16, t5, 0, 0, 32, 0LL);
    goto LAB29;
...
extern void work_m_04217103345188076801_1143475957_init()
{
	static char *pe[] = {(void *)Always_7_0};
	xsi_register_didat("work_m_04217103345188076801_1143475957", "isim/cpu_red_test_isim_beh.exe.sim/work/m_04217103345188076801_1143475957.didat");
